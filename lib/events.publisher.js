...
const { Constants } = require("./events.util");
    ...
    actions: {
        ...
        emit: {
            ...
            async handler(ctx) {
                ...
                //      2) userId 
                //      3) "core"
                let key = _.get(meta,"userId",Constants.DEFAULT_KEY);
                key = _.get(meta,"groupId",key);
                // set new context id, if not provided
                _.set(meta, "flow.contextId", _.get(meta,"flow.contextId", uuid()));
